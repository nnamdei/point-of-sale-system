        ...
        <div class="col-md-8 col-sm-10">
            <div class="card">
                <div class="card-header clearfix">
                    <h6>Backups</h6>
                    <a href="{{ route('backup.create') }}" class="btn btn-sm theme-btn float-right">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            @foreach($backups as $backup)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-sm theme-btn" href="{{ route('backup.download',[$backup['file_name']]) }}" style="border-radius: 3px 0px 0px 3px">
