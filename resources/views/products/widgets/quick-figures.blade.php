<div class="row text-center">
    ...
    <div class="col-4">
        <div class="stats-bold-figure-container">
            <h6>Remaining</h6>
            <h1><span class="badge {{$product->stocksLow() ? 'animated flash infinite slow badge-warning' : 'badge-secondary'}}" data-toggle="tooltip" data-placement="top" title="{{$product->remainsBreakDown()}}">{{$product->remaining()}}</span></h1>
        </div>        
    </div>
</div>
