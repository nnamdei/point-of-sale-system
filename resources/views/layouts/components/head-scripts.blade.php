    ...
    jQuery(document).ready(function($) {
        ...
        $(".product-quick-search").typeahead({
            ...
            templates: {
                ...
                pending: '<div class="list-group-item search-results-dropdown text-center">Hold on, searching...<div class="py-3 text-center"><img src="'+ROOT+'/storage/images/assets/loading.gif'+'" height="70px"></div></div>',
                header: [
